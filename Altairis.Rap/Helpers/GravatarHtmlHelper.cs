...
namespace Altairis.Rap.Helpers {
    ...
    public static class GravatarHtmlHelper {
        ...
        public static HtmlString GravatarImage<T>(this HtmlHelper<T> htmlHelper, string emailAddress, int size = 80, DefaultImage defaultImage = DefaultImage.Default, string defaultImageUrl = "", bool forceDefaultImage = false, Rating rating = Rating.G, bool forceSecureRequest = false) {
